...
public class CountHoursGames {
    ...
    public static List<Integer> findByList(List<OwnedGame> ownedGames){
        ...
        int h0 = 0, h2 = 0, h10 = 0, h50 = 0, h100 = 0, h200 = 0, h500 = 0, h1000 = 0, h2000 = 0, h5000 = 0, haha = 0;
...
//        showlist(list);
    ...
    private static void showlist(List<Integer> list){
        System.out.printf("未启动过的游戏：" + list.get(0) + "\n");
        System.out.printf("0~2小时的游戏：" + list.get(1) + "\n");
        System.out.printf("2~10小时的游戏：" + list.get(2) + "\n");
        System.out.printf("10~50小时的游戏：" + list.get(3) + "\n");
        System.out.printf("50~100小时的游戏：" + list.get(4) + "\n");
        System.out.printf("100~200小时的游戏：" + list.get(5) + "\n");
        System.out.printf("200~500小时的游戏：" + list.get(6) + "\n");
        System.out.printf("500~1000小时的游戏：" + list.get(7) + "\n");
        System.out.printf("1000~2000小时的游戏：" + list.get(8) + "\n");
        System.out.printf("2000~5000小时的游戏：" + list.get(9) + "\n");
        System.out.printf("5000+小时的游戏：" + list.get(10) + "\n");
    }
}
